...
void mouseControl(int button, int state, int x, int y)
{
    if (button == GLUT_LEFT_BUTTON && state == GLUT_DOWN)
        ...
        // Store the clicked point in the points array after correcting from
        // event to OpenGL co-ordinates.
...
void printInteraction(void)
{
    ...
    std::cout << "Left mouse click to draw a square point, right mouse"
              << " click to exit." << std::endl;
}
