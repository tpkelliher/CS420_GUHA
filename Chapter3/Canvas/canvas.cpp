...
// Then left click on the drawing area: once for point, twice for line or
// rectangle.  Right click for menu options.
//
//  Sumanta Guha.
/////////////////////////////////////////////////////////////////////////////
...
public:
    ...
    void drawRectangle();
private:
    // x and y co-ordinates of diagonally opposite vertices.
    float x1, y1, x2, y2;
};
...
void printInteraction(void)
{
    ...
    std::cout << "Left click on a box on the left to select a primitive."
              << std::endl
              << "Then left click on the drawing area: once for point,"
              << std::endl
              << "twice for line or rectangle." << std::endl
