...
void makeMenu(void)
{
    ...
    // menu is created): its callback function is registered and menu entries
    // added.
    int sub_menu;
    ...
    // The top menu is created: its callback function is registered and menu
    // entries, including a submenu, added.
