...
// glutObjects.cpp
//
// This program displays the various objects available thruogh the GLUT
// library.
//
// Interaction:
...
static std::string objName; // Object name.
...
void writeObjectName()
{
    ...
    writeStrokeString(GLUT_STROKE_ROMAN, (char*) objName.c_str());
    glPopMatrix();
}
...
void printInteraction(void)
{
    ...
    std::cout << "Press the arrow keys to cycle through the objects."
              << std::endl
