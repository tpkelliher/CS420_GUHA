...
void drawScene(void)
{
    ...
    if (!animateMode) // Develop mode.
    {
        ...
        for (auto man : manVector) { man.draw(); }
    }
    else // Animated mode - 
...
{
   std::vector<Man>::iterator localManVectorIterator;
    switch (key)
    {
    case 27:
        exit(0);
...
void printInteraction(void)
{
    ...
    std::cout << "Press a to toggle between develop and animate modes." << std::endl
        << std::endl
        << "In develop mode:" << std::endl
        << "Press the space bar to select a part." << std::endl
        << "Press the page up/page down keys to rotate the selected part." << std::endl
        << "Press the left/right/up/down arrow keys to move the whole configuration." << std::endl
        << "Press r/R to rotate the viewpoint." << std::endl
        << "Press z/Z to zoom in/out." << std::endl
        << "Press n to create a new configuration - other configurations are ghosted" << std::endl
        << "(the new configuration is a copy of the current one so it must be moved to be visible)." << std::endl
        << "Press tab to choose a configuration - it is highlighted, others ghosted." << std::endl
        << "Press backspace to reset current configuration." << std::endl
        << "Press delete to delete current configuration." << std::endl
        << std::endl
        << "In animate mode:" << std::endl
