...
void writeFixedMessages(void)
{
    ...
    writeBitmapString((void*)font, "drawRedMan; // Also draw grid in his"
...
step4:
    ...
    writeBitmapString((void*)font,
                      "drawRedMan; // Also draw grid in his local coordinate"
                      " system.");
    glPopMatrix();
...
void printInteraction(void)
{
    ...
    std::cout << "Press the up/down arrow keys to process code statements."
              << std::endl;
}
