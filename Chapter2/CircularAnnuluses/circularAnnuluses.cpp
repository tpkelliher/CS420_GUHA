...
//
// This program draws three identical-looking circular annuluses in three
// different ways - see comments below.
//
// Interaction:
// Press the space bar to toggle between wirefrime and filled for the lower
// annulus.
// 
// Sumanta Guha.
//////////////////////////////////////////////////////////////////////////////
...
// Function to draw a disc with center at (X, Y, Z), radius R, parallel
// to the xy-plane.
...
void drawScene(void)
{
    ...
    int i;
     ...
     // Clear the buffers including the depth buffer.
    ...
    // Upper right circular annulus: the white disc is in front of the
    // red disc blocking it.
    glEnable(GL_DEPTH_TEST); // Enable depth testing. 
    glColor3f(1.0, 0.0, 0.0);
    drawDisc(20.0, 75.0, 75.0, 0.0);
    glColor3f(1.0, 1.0, 1.0);
    // Compare this z-value with that of the red disc.
...
void printInteraction(void)
{
    ...
    std::cout << "Press the space bar to toggle between wirefrime and"
              << " filled for the lower annulus." << std::endl;
}
